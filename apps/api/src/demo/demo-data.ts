...
export async function loadDemoData(prisma: PrismaClient) {
  ...
  await clearPreviousDemoData(prisma);
  ...
  return {
    ...
    /// is exactly why the whole thing refuses to run outside a test deployment.
 ...
 */
async function clearPreviousDemoData(prisma: PrismaClient) {
